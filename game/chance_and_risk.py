chances = [
    ...
    ["You have been invited to a prestigious partnership - move to any field in front", "mv-any"], 
...
'''risks = [
    ...
    ["You sued yourself and lost rights to the software - you go back 3 squares", "mv-_3"],
